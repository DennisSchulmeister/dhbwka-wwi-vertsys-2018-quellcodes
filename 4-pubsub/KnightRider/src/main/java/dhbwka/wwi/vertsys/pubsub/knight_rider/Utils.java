 ...
 */
package dhbwka.wwi.vertsys.pubsub.knight_rider;
...
public class Utils {
    ...
    public static final String MQTT_TOPIC_QUOTE = "KnightRider/Zitate";
    public static final String MQTT_TOPIC_ADD_QUOTE = "KnightRider/NeuesZitat";
