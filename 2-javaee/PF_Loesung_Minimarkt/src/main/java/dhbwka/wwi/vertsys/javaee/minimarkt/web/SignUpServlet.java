...
public class SignUpServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String postcode = request.getParameter("signup_postcode");
        ...
        User user = new User(username, password1, realname, street, postcode, city, phone, email);
        ...
        if (errors.isEmpty()) {
            try {
                this.userBean.signup(username, password1, realname, street, postcode, city, phone, email);
